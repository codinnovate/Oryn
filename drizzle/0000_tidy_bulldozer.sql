...
CREATE TYPE "public"."verification_token_type" AS ENUM('verify_email', 'password_reset');--> statement-breakpoint
...
ALTER TABLE "member_roles" ADD CONSTRAINT "member_roles_member_id_workspace_members_id_fk" FOREIGN KEY ("member_id") REFERENCES "public"."workspace_members"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "verification_tokens_token_hash_uq" ON "verification_tokens" USING btree ("token_hash");--> statement-breakpoint
...
CREATE UNIQUE INDEX "invitations_pending_uq" ON "invitations" USING btree ("workspace_id","email_normalized") WHERE "invitations"."status" = 'pending';--> statement-breakpoint
...
CREATE UNIQUE INDEX "roles_workspace_key_uq" ON "roles" USING btree ("workspace_id","key");--> statement-breakpoint
CREATE INDEX "roles_workspace_idx" ON "roles" USING btree ("workspace_id");